    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            Manage mosque members, volunteers, and leadership.
          </p>
        </div>
        <button
          onClick={openNew}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          {
            label: "Volunteers",
            value: members.filter((m) => m.role === "Volunteer").length,
          },
          {
            label: "Leadership",
            value: members.filter((m) =>
              ["Board Member", "Imam", "Teacher", "Youth Leader"].includes(
                m.role,
              ),
            ).length,
          },
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setForm((f) => ({ ...f, occupations: e.target.value }))
                    }
                    className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-emerald-primary/20 focus:border-emerald-primary"
                  >
                    {OCCUPATIONS.map((r) => (
