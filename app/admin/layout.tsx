    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <aside className="w-[210px] flex-shrink-0 bg-white border-r border-gray-100 flex flex-col">
        ...
        <div className="px-5 py-4 border-b border-gray-100">
          <div className="font-bold text-[#1a5c38] text-[15px] leading-tight">Masjidul Salam</div>
        ...
        <header className="bg-white border-b border-gray-100 px-6 py-3 flex items-center gap-4 flex-shrink-0">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full bg-gray-50 rounded-lg pl-9 pr-4 py-2 text-sm text-gray-700 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#1a5c38]/20 border border-gray-100"
            />
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="text-sm font-medium text-gray-700 border border-gray-200 px-3 py-1.5 rounded-lg hover:bg-gray-50 transition-colors">
              Support
            </button>
